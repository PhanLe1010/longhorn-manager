...
func (in *VolumeAttachmentSpec) DeepCopyInto(out *VolumeAttachmentSpec) {
	*out = *in
	if in.AttachmentSpecs != nil {
		in, out := &in.AttachmentSpecs, &out.AttachmentSpecs
		*out = make(map[string]*AttachmentSpec, len(*in))
		for key, val := range *in {
			var outVal *AttachmentSpec
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
...
func (in *VolumeAttachmentStatus) DeepCopyInto(out *VolumeAttachmentStatus) {
	*out = *in
	if in.AttachmentStatuses != nil {
		in, out := &in.AttachmentStatuses, &out.AttachmentStatuses
		*out = make(map[string]*AttachmentStatus, len(*in))
		for key, val := range *in {
			var outVal *AttachmentStatus
			if val == nil {
				(*out)[key] = nil
			} else {
				in, out := &val, &outVal
